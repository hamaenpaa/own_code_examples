...
/* Object interface: IOmaCtl, ver. 0.0,
   GUID={0xA248D58D,0xE6F3,0x11D3,{0xB4,0xE3,0xE9,0x33,0x32,0xAC,0x01,0x36}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IOmaCtl_ServerInfo;
...
static const unsigned short IOmaCtl_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IOmaCtl_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IOmaCtl_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IOmaCtl_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IOmaCtl_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(18) _IOmaCtlProxyVtbl = 
{
    &IOmaCtl_ProxyInfo,
    &IID_IOmaCtl,
    ...
    (void *)-1 /* IOmaCtl::put_BackColor */ ,
    (void *)-1 /* IOmaCtl::get_BackColor */ ,
    (void *)-1 /* IOmaCtl::put_FillColor */ ,
    (void *)-1 /* IOmaCtl::get_FillColor */ ,
    (void *)-1 /* IOmaCtl::putref_Font */ ,
    (void *)-1 /* IOmaCtl::put_Font */ ,
    (void *)-1 /* IOmaCtl::get_Font */ ,
    (void *)-1 /* IOmaCtl::put_Caption */ ,
    (void *)-1 /* IOmaCtl::get_Caption */ ,
    (void *)-1 /* IOmaCtl::get_kokeiluomin */ ,
    (void *)-1 /* IOmaCtl::put_kokeiluomin */
};


static const PRPC_STUB_FUNCTION IOmaCtl_table[] =
{
...
CInterfaceStubVtbl _IOmaCtlStubVtbl =
{
    &IID_IOmaCtl,
    &IOmaCtl_ServerInfo,
    18,
...
/* 214 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 216 */	NdrFcShort( 0x34 ),	/* Type Offset=52 */
...
const CInterfaceProxyVtbl * _kokeilu_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IOmaCtlProxyVtbl,
    0
};

const CInterfaceStubVtbl * _kokeilu_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IOmaCtlStubVtbl,
    0
};

PCInterfaceName const _kokeilu_InterfaceNamesList[] = 
{
    "IOmaCtl",
    0
};

const IID *  _kokeilu_BaseIIDList[] = 
{
    &IID_IDispatch,
    0
};
...
#define _kokeilu_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _kokeilu, pIID, n)

int __stdcall _kokeilu_IID_Lookup( const IID * pIID, int * pIndex )
{
    
    if(!_kokeilu_CHECK_IID(0))
        {
        *pIndex = 0;
        return 1;
        }
...
const ExtendedProxyFileInfo kokeilu_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _kokeilu_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _kokeilu_StubVtblList,
    (const PCInterfaceName * ) & _kokeilu_InterfaceNamesList,
    (const IID ** ) & _kokeilu_BaseIIDList,
    & _kokeilu_IID_Lookup, 
    1,
    2,

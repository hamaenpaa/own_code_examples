...
NewFileInclude2=#include "HtmlV.h"
LastPage=0
...
Type=0
HeaderFile=HtmlV.h
ImplementationFile=HtmlV.cpp
Filter=N

[CLS:CHtmlVDoc]
Type=0
HeaderFile=HtmlVDoc.h
ImplementationFile=HtmlVDoc.cpp
Filter=N

[CLS:CHtmlVView]
Type=0
HeaderFile=HtmlVView.h
ImplementationFile=HtmlVView.cpp
Filter=C

========================================================================
		ActiveX Control DLL : ROTARYMFC
========================================================================

ControlWizard has created this project for your ROTARYMFC ActiveX Control
...
that make up your ROTARYMFC ActiveX Control DLL.
...
RotaryMFCCtl.h
	This file contains the declaration of the CRotaryMFCCtrl C++ class.

RotaryMFCCtl.cpp
	This file contains the implementation of the CRotaryMFCCtrl C++ class.

RotaryMFCPpg.h
	This file contains the declaration of the CRotaryMFCPropPage C++ class.

RotaryMFCPpg.cpp
	This file contains the implementation of the CRotaryMFCPropPage C++ class.

RotaryMFCCtl.bmp
	This file contains a bitmap that a container will use to represent the
	CRotaryMFCCtrl control when it appears on a tool palette.  This bitmap
	is included by the main resource file RotaryMFC.rc.

...
void CContainerDlg::DoDataExchange(CDataExchange* pDX)
{
	...
	DDX_Control(pDX, IDC_ROTARYMFCCTRL, m_ctlRotaryMFCCtrl);
	//}}AFX_DATA_MAP
}
...
BEGIN_EVENTSINK_MAP(CContainerDlg, CDialog)
	...
	ON_EVENT(CContainerDlg, IDC_ROTARYMFCCTRL, 1 /* Repositioned */, OnRepositionedRotarymfcctrl, VTS_R8)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

void CContainerDlg::OnRepositionedRotarymfcctrl(double dNewPosition) 
{
	m_dAngle = dNewPosition;
	UpdateData(FALSE);
}

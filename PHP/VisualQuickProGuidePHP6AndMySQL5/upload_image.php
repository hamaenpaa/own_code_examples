       ...
       <?php 
		   if (isset($_POST['submitted']))
		   {
		   	    ...
		   	    if ($_FILES['upload']['error'] > 0)
		   	    {
		   	    	...
		   	    	{
		   	    		case 1: print 'The file exceeds the upload_max_filesize setting in php.ini.';
		   	    		        break;
		   	    		case 2: print 'The file exceeds the MAX_FILE_SIZE setting in the HTML form.';
		   	    		        break;
		   	    		...
		   	    		case 8: print 'File upload stopped.';
		   	    		        break;
		   	    		default : print 'A system error occured'; 
		   	    		          break;
		   	    	}
		   	    	print '</strong></p>';
		   	    }
		   	    // Delete the file if it still exists as temporary one
		   	    if (file_exists($_FILE['upload']['tmp_name']) && 
		   	        is_file($_FILE['upload']['tmp_name']))

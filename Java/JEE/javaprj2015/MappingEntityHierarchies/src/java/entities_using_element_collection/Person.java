 ...
 * @author harri
 */
@Entity(name="ELCOLPerson")
@NamedQueries({
  @NamedQuery(name = "ELCOLPerson.findAll", query = "select o from ELCOLPerson o")})
@Table(name = "EMB_PERSON")
@TableGenerator(name = "Person_ID_Generator", table = "ELCOL_PERSON_ID_GEN",
...
public abstract class Person implements Serializable {
    ...
    public String toString() {
        return "embedded_entities.Person[ id=" + id + " ]";
    }
}

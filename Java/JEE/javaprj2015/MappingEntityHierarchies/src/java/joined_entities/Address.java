...
@NamedQueries({
  @NamedQuery(name = "JAddress.findAll", query = "select o from JAddress o")})
@Table(name = "JOIN_ADDRESS")
@TableGenerator(name = "JAddress_ID_Generator", table = "JOIN_ADDRESS_ID_GEN",
...
public class Address implements Serializable {
    ...
    public String toString() {
        return "joined_entities.Address[ id=" + id + " ]";
    }

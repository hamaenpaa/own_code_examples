 ...
 * </pre>
 */
public abstract class ConverterHomePOA extends org.omg.PortableServer.Servant implements 
  org.omg.CORBA.portable.InvokeHandler, ConverterHomeOperations {

  public ConverterHome _this () {
   return ConverterHomeHelper.narrow(super._this_object());
  }

  public ConverterHome _this (org.omg.CORBA.ORB orb) {
    return ConverterHomeHelper.narrow(super._this_object(orb));
  }
  ...
  public org.omg.CORBA.portable.OutputStream _invoke (java.lang.String opName,
    ...
    switch (method.interface_id) {
      case 0: {
        return ConverterHomePOA._invoke(this, method.method_id, _input, handler);
      }
      case 1: {
  ...
  public static org.omg.CORBA.portable.OutputStream _invoke (ConverterHomeOperations _self,
                                                             int _method_id,
                                                             org.omg.CORBA.portable.InputStream _input,
    ...
    try {
      ...
      case 0: {
      try {
        Converter _result = _self.create();

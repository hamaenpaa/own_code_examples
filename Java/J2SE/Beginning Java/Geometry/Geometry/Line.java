...
public class Line
{
	...
	// Return a point as the intersection of two lines -- called from a Line 
	// object
	public Point intersects(final Line line1)
	{
		...
		localPoint.setX(line1.start.getX() + 
				       (line1.end.getX() - line1.start.getX())*num/denom);
		localPoint.setY(line1.start.getY() + 
				       (line1.end.getY() - line1.start.getY())*num/denom);
	...
	{
		return "(" + start + "):(" + end + ")";
		// As "(start):(end)", that is "(x1,y1):(x2,y2)"
	}
}